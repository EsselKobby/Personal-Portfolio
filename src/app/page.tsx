    ...
    <div className="min-h-screen bg-gray-900 text-gray-100">
      <main className="max-w-5xl mx-auto space-y-16 py-12 px-4 sm:px-6 lg:px-8">
        ...
        <section className="text-center">
          ...
          <div>
            <p className="text-lg sm:text-xl text-gray-400 break-words whitespace-normal">
              I am <span className="text-yellow-500 font-bold">Bernard Essel.</span>
            </p>
            <p className="text-lg sm:text-xl text-gray-400 break-words whitespace-normal">
              A <span className="text-yellow-500 font-bold">Software Engineer.</span>
            </p>
            <p className="text-lg sm:text-xl text-gray-400 break-words whitespace-normal">
              I love making interesting stuff and making impact with{" "}
              <span className="text-yellow-500 font-bold">Programming</span> 🚀.
            </p>
          </div>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">
            <span className="text-yellow-500 text-3xl font-bold">/ About Me...</span>
          </h2>
          <div className="flex">
            <p className="text-gray-300">
              Hey there, I’m Bernard, a{" "}
              <span className="text-yellow-500 font-bold">Telecommunications Engineering</span> student passionate about
              networking, cybersecurity, and innovative tech solutions. I specialize in designing and troubleshooting
              network systems, with expertise in <span className="text-yellow-500 font-bold">MATLAB</span>,{" "}
              <span className="text-yellow-500 font-bold">Python</span>, and{" "}
              <span className="text-yellow-500 font-bold">web development</span>. I’m also deeply involved in advancing
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">
            <span className="text-yellow-500 text-3xl font-bold">/ Techs and Tools...</span>
          </h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">
            <span className="text-yellow-500 text-3xl font-bold">/ Projects...</span>
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <Project
              title="TeamTek"
              description="This is a repository that highlights a movie streaming website."
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">
            <span className="text-yellow-500 text-3xl font-bold">/ Contact Me...</span>
          </h2>
